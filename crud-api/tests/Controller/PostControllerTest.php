...
class PostControllerTest extends WebTestCase
{
    ...
    public function testPostCrudFlow(): void
    {
        ...
        echo("json response:::" . $getByIdResponse->getTitleLoc());
        $getData = $this->getContainer()->get('serializer')->deserialize($getByIdResponse->getTitleLoc(), Post::class, "json");
        $this->assertEquals("test title", $getData->getTitle());
        $this->assertEquals("test content", $getData->getTitleLoc());
        ...
        echo("json response of updated post:::" . $updatedResponse->getTitleLoc());
        $updatedData = $this->getContainer()->get('serializer')->deserialize($updatedResponse->getTitleLoc(), Post::class, "json");
        $this->assertEquals("title update", $updatedData->getTitle());
        $this->assertEquals("content update", $updatedData->getTitleLoc());
        ...
        echo("json response of updated post status:::" . $updatedStatusResponse->getTitleLoc());
        $updatedStatusData = $this->getContainer()->get('serializer')->deserialize($updatedStatusResponse->getTitleLoc(), Post::class, "json");
        $this->assertEquals("title update", $updatedStatusData->getTitle());
        $this->assertEquals("content update", $updatedStatusData->getTitleLoc());
        ...
        echo("json response of comments:::" . $commentsResponse->getTitleLoc());
        $this->assertResponseStatusCodeSame(200);
        $this->assertStringContainsString("test comment", $commentsResponse->getTitleLoc());
