 ...
 */
final class Version20220211035751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id NOT NULL, title VARCHAR(255) NOT NULL, title_loc VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        // $this->addSql('COMMENT ON COLUMN post.id IS \'(DC2Type:number)\'');
