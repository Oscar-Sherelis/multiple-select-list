...
class PostController extends AbstractController
{
   ...
   function all(): Response
   {
    ...
    public function update($id, #[Body] UpdatePostDto $data): Response
    {
    ...
    public function updateStatus($id, #[Body] UpdatePostStatusDto $data): Response
    {
        $entity = $this->posts->findOneBy(["id" => $id]);
        if (!$entity) {
            throw new PostNotFoundException($id);
